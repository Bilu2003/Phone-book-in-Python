...
from data_contact import Kontakt, KsiazkaTeleadresowa
...
display_contact_button = ctk.CTkButton(master=main_window, text="Wyświetl dane kontaktu", command=display_data_contact.display_contact(Lista), width=200, height=50, corner_radius=12)
