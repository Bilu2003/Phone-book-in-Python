...
from add_cont_funk import *
from customtkinter import *




def display_contact(Lista):
    imiona = [osoba.imie for osoba in Lista]
    ...
    contact_choice=CTkComboBox(master=choose_contact_window, values=imiona)
